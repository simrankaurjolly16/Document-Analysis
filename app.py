...
__file__ = '/Users/simrankaur/NER-OCR/'

app = Flask(__name__, template_folder='/Users/simrankaur/NER-OCR/templates/')
...
#         image = destinationpython app.py
        ...
        for c in cnts:
            ...
            cv2.imwrite("contour1.jpg", sharpened)
        #dispImage = cv2.cvtColor(sharpened.copy(), cv2.COLOR_BGR2RGB)
        ...
        for c in cnts:
            cv2.drawContours(sharpened, [c], -1, (255,255,255), 5)
            cv2.imwrite("contour2.jpg", sharpened)
        ...
        df4.to_csv('/Users/simrankaur/NER-OCR/templates/data.csv', index=False)
        print(df4)
        df4.to_html('/Users/simrankaur/NER-OCR/templates/table1.html')
        print("success")
